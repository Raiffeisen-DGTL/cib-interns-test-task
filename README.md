## Что было сделано
* Веб-приложение на Spring Boot, развернуто на heroku, доступно по адресу https://afternoon-hamlet-01402.herokuapp.com (POST методы хероку воспринимает как GET, увы)
* БД PostgreSQL развернута также на heroku, несколько ChangeSet-ов в resources/db/changeset при помощи Liquibase. Датаклип со всеми записями таблицы socks в текущий момент времени : https://data.heroku.com/dataclips/yopnaeuyhivdulgpcrpmwbocchrj
* Несколько простеньких JUnit тестов для Rest-контроллера
