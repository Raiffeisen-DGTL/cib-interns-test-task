...
Первичный ключ базы: цвет + содержание хлопка

1) **GET** ``/api/socks/all ``  
* получить все объекты
* возвращает: все объекты класса Sock в Json
 * параметры: отсутствуют

2) **POST** ``/api/socks/income `` 
* добавить необходимое количество пар носков
* возвращает: *пустое тело*
* параметры:
* **color**-цвет (строка)
* **cottonPart** - содержание хлопка (целочисленное число)
* **quantity** -  число пар, которое нужно добавить (целочисленное число)
*если первичный ключ из запроса не будет присутствовать, то создается новая строка*

3) **POST** ``/api/socks/outcome``  
* убрать необходимое количество пар носков
* возвращает: *пустое тело*
* параметры:
* **color**-цвет (строка)
* **cottonPart** - содержание хлопка (целочисленное число)
...
*если первичный ключ из запроса не будет присутствовать, то создается новая строка; если в результате запроса получается, что количество пар носков в таблице - отрицательное число, то возвращается **500***

4) **GET**``/api/socks`` 
* получить данные
* возвращает: *число, которое равно сумме всех пар носков с данным цветом в зависимости от операции
* параметры:
* **color**-цвет (строка)
* **cottonPart** - содержание хлопка (целочисленное число)
* **operation** -  ["moreThan", "equal", "lessThan"]
