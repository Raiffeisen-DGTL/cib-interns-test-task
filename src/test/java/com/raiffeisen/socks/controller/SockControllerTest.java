...
public class SockControllerTest {
    ...
    void incomeSocksTest() throws Exception {
        SockDto sockDto = new SockDto(RED_COLOR, 32, 32);
    ...
    void getSocksByParamsTest() throws Exception {
        SockDto sockDto = new SockDto(RED_COLOR, 32, 320);
        Mockito.when(socksService.getSocksByParams(RED_COLOR, CORRECT_OPERATION, CORRECT_COTTON_PART)).thenReturn(sockDto);
        mockMvc.perform(MockMvcRequestBuilders.get("/api/socks")
                .param("color", RED_COLOR)
    ...
    void getSocksByIncorrectParamsTest() throws Exception {
        Mockito.when(socksService.getSocksByParams(RED_COLOR, INCORRECT_OPERATION, INCORRECT_COTTON_PART))
