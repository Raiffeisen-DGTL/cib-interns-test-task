...
public class SocksService implements ISocksService{
    ...
    public @NonNull Socks getByColorAndCottonPart(@NonNull String color, @NonNull Operations operation, @NonNull Long cottonPart) {
        switch (operation) {
            case moreThan:
                return socksRepository.getSocksByColorAndCottonPartIsGreaterThan(color, cottonPart)
                        .orElseThrow(()->new NullResultException("Nothing was found for this query"));
            case lessThan:
                return socksRepository.getSocksByColorAndCottonPartLessThan(color, cottonPart)
                        .orElseThrow(()->new NullResultException("Nothing was found for this query"));
            case equals:
                return socksRepository.getSocksByColorAndCottonPartEquals(color, cottonPart)
                        .orElseThrow(()-> new NullResultException("Nothing was found for this query"));
            default:
