...
public class Socks {
  ...
  /**
   * Creates {@link ru.danilarassokhin.raiffeisensocks.model.SocksId}
   * from this entity's data.
   *
   * @return {@link ru.danilarassokhin.raiffeisensocks.model.SocksId} object
   */
