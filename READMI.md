Добрый день!
Это репозиторий с моим тестовым заданием.
Проект и БД также "развёрнуты" на Heroku:
https://sockservice.herokuapp.com/


В БД уже есть некоторые "тестовые" данные, т.е. таблица не пустая.
